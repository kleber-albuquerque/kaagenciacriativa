// KA Widget v2.3 - Funcional, JSON puro e leitura de data-client-id
(function() {
...
window.getChatHistory = function() {
  ...
  return history; // Retorna array (será stringificado no payload)
};
...
setTimeout(function() {
  ...
  console.log('🎉 KA Widget v2.3 Finalizado com Sucesso!');
}, 100);
})();
